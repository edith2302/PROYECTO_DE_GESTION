...
<div class="usuario-index">
    ...
    <a  class=" btn btn-primary" href="index.php?r=usuario/export-pdf2" >Exportar PDF <i class="fa fa-file-pdf-o"></i> </a>
    ...
    <?php // echo Html::a('Exportar Excel', ['export-excel3'], ['class' => 'btn btn-primary']) ?>
       <a class="btn btn-primary" href="index.php?r=usuario/export-excel1" target="_blank">Exportar Excel <i class="fa fa-file-excel-o" aria-hidden="true"></i></a>
    </p>
