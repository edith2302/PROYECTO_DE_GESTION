...
?>
<div class="hito-viewinformefinal">
...
<?= GridView::widget([
            ...
            [
                ...
                'buttons' => [
                    'link' => function ($url, $model, $key) {
                        return ($model['evidencia'] != '') ? Html::a('     <img src="images/iconos/archivos.png" width="20" height="20">', 'archivos/'.$model['evidencia'], ['target' => '_blank']) : '';
                    },
                ],
            ],
        ...
        [
            ...
            [
                ...
                'urlCreator' => function ($action, $model, $key, $index, $column) {
                    //return Url::toRoute([$action, 'id' => $model['id']]);
                    $url ='index.php?r=entrega%2Fevaluadorfinal&id='.$model['id'];
                    return $url;
                }
            ],
